...
args = parser.parse_args(args=['--gpu', '0', '-w', '512', '-a', 'resnet18'])
args.pretrained = os.path.join("app", "models", "classical_simclr.pth.tar") # pre-trained network
...
def predict_simCLR(fingerprint_img):
